...
export declare class ProductsController {
    ...
    deleteProduct(id: string): Promise<import("../../shared/entities/products/product.entity").Product>;
    generateRandomProducts(count: string): Promise<import("../../shared/entities/products/product.entity").Product[]>;
}
